...
| Upstream | sockerless [#257](https://github.com/e6qu/sockerless/issues/257) (umbrella for Azure ARM gaps) closed via [PR #259](https://github.com/e6qu/sockerless/pull/259), which adds configurable Azure ARM data-plane endpoint emission + fills missing ARM surfaces (RG list, account/vault PATCH, KV soft-delete modeling, provider metadata). Earlier follow-ons #239–#245 closed via sockerless PR #242 / #245. |
