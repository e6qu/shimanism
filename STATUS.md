...
| Bugs | 21 filed · 19 fixed · 2 open · 1 false positive. BUG-8 remains the GCP Terraform-provider endpoint/OAuth leg; the GCP APIGW backend lane is green against sockerless. BUG-15 remains the hashicorp/google Terraform state-drift question; the shim's GCP queue backend retention PATCH/read round-trip is green against sockerless. BUG-21 fixed the kind-backed CI installer failure. No upstream sockerless blocker is open at this checkpoint. |
