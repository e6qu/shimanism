...
| Upstream watch | [sockerless#356](https://github.com/e6qu/sockerless/issues/356) closed by [sockerless PR #357](https://github.com/e6qu/sockerless/pull/357) on 2026-06-01 — Cosmos + Storage Tables ARM coverage. Unblocks `azurerm_cosmosdb_table` TF + `az cosmosdb table` CLI conformance (queued as next 15.C PRs). |
