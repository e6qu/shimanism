...
| Upstream watch | [sockerless#356](https://github.com/e6qu/sockerless/issues/356) closed by [sockerless PR #357](https://github.com/e6qu/sockerless/pull/357) on 2026-06-01 — Cosmos + Storage Tables ARM coverage. [sockerless PR #358](https://github.com/e6qu/sockerless/pull/358) merged 2026-06-02 — full Linux netns per VPC + NAT/IPAM. [sockerless#360](https://github.com/e6qu/sockerless/issues/360) filed + closed same day via [sockerless PR #361](https://github.com/e6qu/sockerless/pull/361) — DynamoDB `DeleteItem ReturnValues=ALL_OLD` now honoured. |
