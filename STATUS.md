...
| In-flight | **Phase 14 — Sockerless-verified validation lane + deferred follow-ons.** **14.A done** (2026-05-24): sockerless PR #179 closed all 6 round-1 issues (#173-178); shim assertions re-enabled. **14.D round-2 audit done** (2026-05-24): 8 round-2 issues filed; all closed by sockerless PR #180. **14.B in flight** (2026-05-24): new per-service lanes wiring — pubsub (GCP), queue (GCP + AWS), apigateway (GCP — closes BUG-8 SDK leg) land on top of storage/secrets. Round-3 audit in progress: 3 new sockerless issues filed ([#189](https://github.com/e6qu/sockerless/issues/189) Pub/Sub PATCH missing — blocks BUG-15 closure, [#190](https://github.com/e6qu/sockerless/issues/190) Azure Blob path-style URLs return 404, [#191](https://github.com/e6qu/sockerless/issues/191) Azure KV secret URLs use HTTP scheme). 14.C (full handler migrations for 9 blank-import frontends) still independent + pending. |
...
| Bugs | 20 filed · 18 fixed · 2 open · 1 false positive. Both open bugs (BUG-8, BUG-15) absorbed into Phase 14 — BUG-8 closure path clear (GCP APIGW lane passes via sockerless), BUG-15 closure waits on sockerless#189 (PATCH on subscriptions). Plus 17 upstream-sockerless issues: 14 closed (sockerless PR #179 + #180) + 3 round-3 open (#189-191). |
