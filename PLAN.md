...
| 12.B.2–9 | ◻ | Adapter migrations that compare hand-written regex routes against the generated `gen.gcp.Routes` inventory, then migrate dispatch to use the spec-driven patterns. Per-service work; follow-on. |
