...
| **5.16** | ✅ | Phase 5 closer: STATUS / WHAT_WE_DID / BUGS / DO_NEXT refreshed. PR #10 updated (initially titled WIP); the WIP marker can come off in the closer commit. Documented skips: 3 cells (1 AWS TF, 2 GCP CLI+TF, 2 Azure CLI+TF) plus the always-skipped real-cloud cells in matrix tests. Exit criterion (5.15) gated on CI's conformance-cnpg lane. |
