...
func mapDomainError(w http.ResponseWriter, err error) {
	...
	switch de.Kind {
	case domain.KindNoSuchInstance, domain.KindNoSuchSnapshot:
		writeError(w, http.StatusNotFound, "NOT_FOUND", de.Error())
	case domain.KindInstanceAlreadyExists, domain.KindSnapshotAlreadyExists:
		writeError(w, http.StatusConflict, "ALREADY_EXISTS", de.Error())
	case domain.KindUnsupportedEngine, domain.KindInvalidArgument, domain.KindInstanceNotAvailable:
