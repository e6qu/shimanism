...
| `gcp-apigateway-discovery.json` | `apigateway.googleapis.com` | `$discovery/rest?version=v1` (live Discovery document) | Apache-2.0 | revision `20260513` | 2026-05-22T11:35:00Z |
