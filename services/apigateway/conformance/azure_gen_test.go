// Phase 12.A toolchain invariant: the apigateway service's Azure
...
import (
	...
	azuregen "github.com/e6qu/shimanism/services/apigateway/gen/azure"
)

func TestAzureGen_Apigateway_PackageCompiles(t *testing.T) {
